...
import $settingBackground, { throttleChangeBackgroundBlur, throttleChangeBackgroundOpacity } from "@/store/models/settings/background";
...
const PageStyleChange: FunctionComponent<PageStyleChangeProps> = () => {
  ...
  function handleSelectChange(value: string) {
    const storeVal = $settingBackground.get().backgroundOptions.find(o => o.pageName === value)
  ...
  return (
    <>
      <StyledTooltip
        title="对每个页面设置不同的背景样式以增强背景融入效果，一般不需要手动设置"
      >
