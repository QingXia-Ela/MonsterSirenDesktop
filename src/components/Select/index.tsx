...
const DropDown: FunctionComponent<DropDownProps> = ({
  ...
  const [currentLabel, setCurrentLabel] = useState(value ? options.find(option => option.value === value)?.label : "");
  const [isOpen, handleClick] = useCloseState("data-select-wrapper", closeAfterSelect);
