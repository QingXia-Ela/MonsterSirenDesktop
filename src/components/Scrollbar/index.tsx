...
import { ScrollbarProps as CustomScrollbarProps, Scrollbars } from 'react-custom-scrollbars';
...
const Scrollbar: FunctionComponent<PropsWithChildren<ScrollbarProps>> = ({ children, marginBarHeightLimit = 0, ScrollbarDegNum, VirtuosoOptions, ScrollbarProps }) => {
